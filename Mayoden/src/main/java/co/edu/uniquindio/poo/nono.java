...
public class nono {
    ...
    public nono(String idunic, String nombre, int edad, char genero, String identificacion, String alergias, String nombredeacudiente, String telefono) {
        this.idunic = idunic;
        this.nombre = nombre;
        this.edad = edad;
        this.genero = genero;
...
class GenerarMensaje2 {
    public static void main(String[] args) {
        ArrayList<nono> menores = new ArrayList<>();
        ...
        while (true) {
            ...
            nono menor = new nono(idunic, nombre, edad, genero, identificacion, alergias, nombredeacudiente, telefono);
            menores.add(menor);
