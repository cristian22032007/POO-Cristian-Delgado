...
public class Guarderia2 {
        ...
        public Guarderia2 (String idunic, String nombre, int edad, char genero, String identificacion, String alergias, String nombredeacudiente, String telefono) {
            this.idunic = idunic;
            this.nombre = nombre;
            this.edad = edad;
            this.genero = genero;
    ...
    class GenerarMenor2 {
        public static void main(String[] args) {
            ArrayList<Guarderia2> menores = new ArrayList<>();
            ...
            while (true) {
                ...
                Guarderia2 menor = new Guarderia2(idunic, nombre, edad, genero, identificacion, alergias, nombredeacudiente, telefono);
                menores.add(menor);
